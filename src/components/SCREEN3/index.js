	...
	return(<Wrapper>
		<div id="section-2">
            ...
            <div class="games-flex">
				<img className="mt-3" src={'/assets/images/partners/btc.png'} /> 
				<img className="mt-3" src={'/assets/images/partners/nw.png'} /> 
				<img className="mt-3" src={'/assets/images/partners/aw.png'} /> 
            </div>  
			<img src={'/assets/images/miner1.png'} />
		</div>	
	</Wrapper>)  
}
