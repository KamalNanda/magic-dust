...
import s2l from '../../assets/images/s2-left.png' 
import s2r from '../../assets/images/s2-right.png'
		...
		<div id="section-1"> 
				<Row>
					...
					</Col>
					{
						list1.map((l, i) => {
							return <Col lg={6} md={6} sm={12}>
										<PinkBox key={i} > 
											<div class="d-flex"><img src={heart} className="heart"/><p>{l}</p></div>
										</PinkBox>
									</Col>
						})
					}
					<Row className="justify-content-between align-items-center">
						<Col lg={8} md={8} sm={12}>
							<img style={{width:'100%'}} src={s2l} alt="s2l" />
						</Col>
						<Col lg={4} md={4} sm={12}>
							<img style={{width:'100%'}} src={s2r} alt="s2r" />
						</Col>
					</Row>
					{
						list2.map((l, i) => {
