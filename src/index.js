...
window.addEventListener('scroll', function(){
    ...
    left.style.top = document.getElementById('home').offsetTop  + document.getElementById('home').offsetHeight -value * 0.50 + 'px'
    right.style.top =  document.getElementById('home').offsetTop + document.getElementById('home').offsetHeight  + document.getElementById('home').offsetHeight/3   -value * 0.50 + 'px' 
